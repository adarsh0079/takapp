  ...
  return (
    <div className="w-[375px]  h-[800px] mx-auto border-2 relative">
      ...
      <div>
        ...
        <button
          className={`w-[90%] block mt-5 mx-auto h-[50px] bg-violet-500 rounded-tl-lg rounded-tr-lg rounded-br-lg text-white ${tnc ? "" : "!bg-gray-400 "
            }`}
          onClick={onSubmit}
        >
          Save
